<#	
    ...
    ===========================================================================
        ...
        Version:        0.1
        Project:        PSGUI
        Filename:       New-PackageByDialog.ps1
    ===========================================================================
    .DESCRIPTION
        Function from the PSGUI module.
#> 
function New-PackageByDialog
{
    <#
        .Synopsis
    ...
    Process
    {
        ...
        #region creating folder structure for using computer
            ...
            Copy-Item $DialogPath "$tempPKGFolder\Dialogs" -Recurse -Force
        #endregion
...
#Test
#New-PackageByDialog -DialogName 'clean' -Dialogpath 'C:\OneDrive\_Projekte\PS\PSGUI\Project PSGUI\GUI_Manager\Dialogs\Clean' -OutputName MyDialog